...
/**
 * Object that stores common Employee information.
...
public class Employee implements Cloneable {
	 ...
	 */
	public void setEmployeeId(int no) {
		this.no = no;
	}
	...
	public static void main(String[] args) {
		...
		e3.setEmployeeId( 990010 );
		System.out.println("Employee #1 has the employee number: " + e1.getEmployeeId() );
		System.out.println("Employee #2 has the employee number: " + e2.getEmployeeId() );
		System.out.println("\tBy evaluating the two using .equals(), the return value is: " + e1.equals( e2 ));
		System.out.println("\n");
		
		System.out.println("Employee #1 has the employee number: " + e1.getEmployeeId() );
		System.out.println("Employee #3 has the employee number: " + e3.getEmployeeId() );
