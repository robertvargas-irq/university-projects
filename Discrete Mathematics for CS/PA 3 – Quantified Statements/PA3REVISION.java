...
public class PA3REVISION {
    ...
    public static boolean statementA( int[] array ) {
        ...
        for ( int x : array ) {
            ...
            char xLessThanZero = PA2Methods.booleanToChar( x < 0 );
            char xIsEven = PA2Methods.booleanToChar( x % 2 == 0 );
            char impliesStatement = PA2Methods.implies( xLessThanZero, xIsEven );
            
            if ( PA2Methods.charToBoolean( impliesStatement ) == false )
               return false;
    ...
    public static boolean statementB( int[] array ) {
        ...
        for ( int x : array ) {
            ...
            if ( PA2Methods.charToBoolean( impliesStatement ) == true )
               return true;
    ...
    public static boolean statementC( int[] array ) {
        ...
        for ( int x : array ) {
            ...
            char xLessThanZero = PA2Methods.booleanToChar( x < 0 );
            char xIsEven = PA2Methods.booleanToChar( x % 2 == 0 );
            char andStatement = PA2Methods.and( xLessThanZero, xIsEven );
            
            if ( PA2Methods.charToBoolean( andStatement ) == true )
                return true;
    ...
    public static boolean statementD( int[] array ) {
        ...
        for ( int x : array ) {
            ...
            char divisibleByThree = PA2Methods.booleanToChar( (x - 1) % 3 == 0 );
            char divisibleByTwo = PA2Methods.booleanToChar( (x - 1) % 2 == 0 );
            char orStatement = PA2Methods.or( divisibleByThree, divisibleByTwo );
            
            if ( PA2Methods.charToBoolean( orStatement ) == false )
                return false;
