...
//             The functions will now be put into action with
//             3 custom truth tables for 3 compound propositions
//             given by the proctor.
...
public class PA1Test {
    ...
    public static void main( String args[] ) {
        ...
        //
        // Proposition 1: not(q) and r and p
        //
        ...
        for ( String row : truthTable )
            System.out.println( row + and( and( not(row.charAt(3)), row.charAt(6) ), row.charAt(0) ) );
        System.out.println();
        
        
        
        //
        // Proposition 2: ( p and not(r) )
        //
        
        System.out.println("Truth table for ( p and not(r) )");
        System.out.println();
        ...
        // build table and parse proposition
        for ( String row : truthTable )
            System.out.println( row + and( row.charAt(0), not(row.charAt(6)) ) );
        System.out.println();
        
        
        
        //
        // Proposition 3: p and q and r
        //
        ...
        // build table and parse proposition
        for ( String row : truthTable )
            System.out.println( row + and( and( row.charAt(0), row.charAt(3) ), row.charAt(6) ) );
        System.out.println();
